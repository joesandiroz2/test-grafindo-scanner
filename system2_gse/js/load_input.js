...
<div  style="color:black;padding: 3px  2px; width: calc(33.33% - 30px);display:inline-block">
    <div class="label" style=" page-break-inside: avoid; width:280px;border-radius:10px; border: 1px solid black;position: relative;margin-bottom:14px;margin-left:53px">
