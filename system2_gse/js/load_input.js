...
function openPrintModal(merk, partNumber, namaBarang, qty, satuan, berapa_lembar, lot, depo, supplierId, tglInspeksi) {
    ...
    for (let l = 0; l < berapa_lembar; l++) {
        let lembarHTML = `<div class="lembar" style="margin-top:18px;margin-left:15px;page-break-after: always;">`;
...
lembarHTML += `
<div  style="color:black;padding: 3px  8px; width: calc(33.33% - 10px);display:inline-block">
