...
function openPrintModal(merk, partNumber, namaBarang, qty, satuan, berapa_lembar, lot, depo, supplierId, tglInspeksi) {
    ...
    for (let l = 0; l < berapa_lembar; l++) {
        let lembarHTML = `<div class="lembar" style="margin-top:20px;page-break-after: always;">`;
...
<div  style="color:black;padding: 3px  6px; width: calc(33.33% - 10px);display:inline-block">
    <div class="label" style=" page-break-inside: avoid; width:290px;border-radius:10px; border: 1px solid black;position: relative;margin-bottom:35px;margin-left:7px">
