...
<div  style="color:black;padding: 3px  2px; width: calc(33.33% - 35px);display:inline-block">
    <div class="label" style=" page-break-inside: avoid; width:280px;border-radius:10px; border: 1px solid black;position: relative;margin-bottom:13px;margin-left:52px">
