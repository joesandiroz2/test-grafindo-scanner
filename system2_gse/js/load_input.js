...
function openPrintModal(merk, partNumber, namaBarang, qty, satuan, berapa_lembar, lot, depo, supplierId, tglInspeksi) {
    ...
    for (let l = 0; l < berapa_lembar; l++) {
        let lembarHTML = `<div class="lembar" style="margin-top:18px;margin-left:18px;page-break-after: always;">`;
...
lembarHTML += `
<div  style="color:black;padding: 3px  12px; width: calc(33.33% - 10px);display:inline-block">
    <div class="label" style=" page-break-inside: avoid; width:320px;border-radius:10px; border: 1px solid black;position: relative;margin-bottom:25px;margin-left:12px">
