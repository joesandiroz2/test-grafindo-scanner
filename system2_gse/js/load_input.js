...
<div  style="color:black;padding: 3px  2px; width: calc(33.33% - 25px);display:inline-block">
    <div class="label" style=" page-break-inside: avoid; width:230px;border-radius:10px; border: 1px solid black;position: relative;margin-bottom:25px;margin-left:30px">
