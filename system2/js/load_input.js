...
function openPrintModal(merk, partNumber, namaBarang, qty, satuan, lot, depo, supplierId, tglInspeksi) {
    ...
    if (modalBody) {
        ...
        modalBody.innerHTML = `
            ...
            <div class="row" style="margin-right:52px" id="labelContainer"></div>`;
        ...
        for (let i = 0; i < satuan; i++) {
            ...
            let labelHTML = `
            <div  style="color:black;padding: 3px  55px; width: calc(33.33% - 10px);margin-right:10px;">
                <div class="label" style="width:340px;border-radius:10px; border: 1px solid black;  padding: 2px; position: relative;margin-bottom:30px;">
