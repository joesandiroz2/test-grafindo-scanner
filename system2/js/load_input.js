    ...
    if (modalBody) {
        ...
        for (let i = 0; i < satuan; i++) {
            ...
            <div  style="color:black;padding: 3px  18px; width: calc(33.33% - 10px);">
                <div class="label" style=" page-break-inside: avoid; width:340px;border-radius:10px; border: 1px solid black;position: relative;margin-top:12px;margin-bottom:15px;margin-left:7px">
